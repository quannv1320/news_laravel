                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-9">
                            <div class="header-banner f-right ">
                                <img src="{{ asset('client/assets/img/gallery/header_card.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="slider-active">
                            ...
                            <div class="single-slider">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="{{ asset('client/assets/img/trending/trending_top2.jpg') }}" alt="">
                            ...
                            <div class="single-slider">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="{{ asset('client/assets/img/trending/trending_top02.jpg') }}" alt="">
                                        <div class="trend-top-cap">
                                            <span class="bgr" data-animation="fadeInUp" data-delay=".2s" data-duration="1000ms">Business</span>
                                            <h2><a href="latest_news.html" data-animation="fadeInUp" data-delay=".4s" data-duration="1000ms">Anna Lora Stuns In White At Her Australian Premiere</a></h2>
                                            <p data-animation="fadeInUp" data-delay=".6s" data-duration="1000ms">by Alice cloe   -   Jun 19, 2020</p>
                            ...
                            <div class="single-slider">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="{{ asset('client/assets/img/trending/trending_top03.jpg') }}" alt="">
                                        <div class="trend-top-cap">
                                            <span class="bgr" data-animation="fadeInUp" data-delay=".2s" data-duration="1000ms">Business</span>
                                            <h2><a href="latest_news.html" data-animation="fadeInUp" data-delay=".4s" data-duration="1000ms">Anna Lora Stuns In White At Her Australian Premiere</a></h2>
                                            <p data-animation="fadeInUp" data-delay=".6s" data-duration="1000ms">by Alice cloe   -   Jun 19, 2020</p>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-6 col-sm-6">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="{{ asset('client/assets/img/trending/trending_top3.jpg') }}" alt="">
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="{{ asset('client/assets/img/trending/trending_top4.jpg') }}" alt="">
                                        <div class="trend-top-cap trend-top-cap2">
        ...
        <div class="container">
            <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-12">
                                            <div class="whats-news-single mb-40 mb-40">
                                                <div class="whates-img">
                                                    <img src="{{ asset('client/assets/img/gallery/whats_news_details1.png') }}" alt="">
                                                </div>
                                        ...
                                        <div class="col-xl-6 col-lg-12">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                    <div class="whats-right-single mb-20">
                                                        <div class="whats-right-img">
                                                            <img src="{{ asset('client/assets/img/gallery/whats_right_img1.png') }}" alt="">
                                                        </div>
                                                ...
                                                <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                    <div class="whats-right-single mb-20">
                                                        <div class="whats-right-img">
                                                            <img src="{{ asset('client/assets/img/gallery/whats_right_img2.png') }}" alt="">
                                                        </div>
                                                        <div class="whats-right-cap">
                                                            <span class="colorb">FASHION</span>
                                                            <h4><a href="latest_news.html">Portrait of group of friends ting eat. market in.</a></h4>
                                                ...
                                                <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                    <div class="whats-right-single mb-20">
                                                        <div class="whats-right-img">
                                                            <img src="{{ asset('client/assets/img/gallery/whats_right_img3.png') }}" alt="">
                                                        </div>
                                                        <div class="whats-right-cap">
                                                ...
                                                <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                    <div class="whats-right-single mb-20">
                                                        <div class="whats-right-img">
                                                            <img src="{{ asset('client/assets/img/gallery/whats_right_img4.png') }}" alt="">
                                                        </div>
                                                        <div class="whats-right-cap">
                ...
                <div class="banner-one mt-20 mb-30">
                    <img src="{{ asset('client/assets/img/gallery/body_card1.png') }}" alt="">
                </div>
                </div>
                <div class="col-lg-4">
                    <!-- Flow Socail -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="home-banner2 d-none d-lg-block">
                            <img src="{{ asset('client/assets/img/gallery/body_card2.png') }}" alt="">
                        </div>
                    </div>
                    <div class="col-lg-9">
                                    ...
                                    <div class="weekly2-news-active d-flex">
                                        ...
                                        <div class="weekly2-single">
                                            <div class="weekly2-img">
                                                <img src="{{ asset('client/assets/img/gallery/weeklyNews1.png') }}" alt="">
                                            </div>
                                        ...
                                        <div class="weekly2-single">
                                            <div class="weekly2-img">
                                                <img src="{{ asset('client/assets/img/gallery/weeklyNews2.png') }}" alt="">
                                            </div>
                                            <div class="weekly2-caption">
                                                <h4><a href="#">Scarlett’s disappointment at latest accolade</a></h4>
                                                <p>Jhon  |  2 hours ago</p>
                                        ...
                                        <div class="weekly2-single">
                                            <div class="weekly2-img">
                                                <img src="{{ asset('client/assets/img/gallery/weeklyNews3.png') }}" alt="">
                                            </div>
                                            <div class="weekly2-caption">
                                                <h4><a href="#">Scarlett’s disappointment at latest accolade</a></h4>
                                                <p>Jhon  |  2 hours ago</p>
                    ...
                    <div class="col-12">
                        <div class="recent-active dot-style d-flex dot-style">
                            ...
                            <div class="single-recent">
                                <div class="what-img">
                                    <img src="{{ asset('client/assets/img/gallery/tranding1.png') }}" alt="">
                                </div>
                                <div class="what-cap">
                            ...
                            <div class="single-recent">
                                <div class="what-img">
                                    <img src="{{ asset('client/assets/img/gallery/tranding2.png') }}" alt="">
                                </div>
                                <div class="what-cap">
                                    ...
                                    <div class="weekly3-news-active dot-style d-flex">
                                        <div class="weekly3-single">
                                            <div class="weekly3-img">
                                                <img src="{{ asset('client/assets/img/gallery/weekly2News1.png') }}" alt="">
                                            </div>
                                        ...
                                        <div class="weekly3-single">
                                            <div class="weekly3-img">
                                                <img src="{{ asset('client/assets/img/gallery/weekly2News2.png') }}" alt="">
                                            </div>
                                            <div class="weekly3-caption">
                                                <h4><a href="latest_news.html">What to Expect From the 2020 Oscar Nomin ations</a></h4>
                                                <p>19 Jan 2020</p>
                                        ...
                                        <div class="weekly3-single">
                                            <div class="weekly3-img">
                                                <img src="{{ asset('client/assets/img/gallery/weekly2News3.png') }}" alt="">
                                            </div>
                                            <div class="weekly3-caption">
                                                <h4><a href="latest_news.html">What to Expect From the 2020 Oscar Nomin ations</a></h4>
                                                <p>19 Jan 2020</p>
                                        ...
                                        <div class="weekly3-single">
                                            <div class="weekly3-img">
                                                <img src="{{ asset('client/assets/img/gallery/weekly2News4.png') }}" alt="">
                                            </div>
                                            <div class="weekly3-caption">
                                                <h4><a href="latest_news.html">What to Expect From the 2020 Oscar Nomin ations</a></h4>
                                                <p>19 Jan 2020</p>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-md-10">
                    <div class="banner-one">
                        <img src="{{ asset('client/assets/img/gallery/body_card3.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row d-flex justify-content-between">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-5 col-sm-7">
                        <div class="single-footer-caption mb-50">
                            ...
                            <div class="whats-right-single mb-20">
                                <div class="whats-right-img">
                                    <img src="{{ asset('client/assets/img/gallery/footer_post1.png') }}" alt="">
                                </div>
                                <div class="whats-right-cap">
                                    <h4><a href="latest_news.html">Scarlett’s disappointment at latest accolade</a></h4>
                                    <p>Jhon  |  2 hours ago</p> 
                            ...
                            <div class="whats-right-single mb-20">
                                <div class="whats-right-img">
                                    <img src="{{ asset('client/assets/img/gallery/footer_post2.png') }}" alt="">
                                </div>
                                <div class="whats-right-cap">
                                    <h4><a href="latest_news.html">Scarlett’s disappointment at latest accolade</a></h4>
                                    <p>Jhon  |  2 hours ago</p> 
                            ...
                            <div class="whats-right-single mb-20">
                                <div class="whats-right-img">
                                    <img src="{{ asset('client/assets/img/gallery/footer_post3.png') }}" alt="">
                                </div>
                                <div class="whats-right-cap">
                                    <h4><a href="latest_news.html">Scarlett’s disappointment at latest accolade</a></h4>
                                    <p>Jhon  |  2 hours ago</p> 
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-5 col-sm-7">
                        <div class="single-footer-caption mb-50">
                            <div class="banner">
                                <img src="{{ asset('client/assets/img/gallery/body_card4.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
